...
def add_subparser_airevision(subparsers):
    ...
    parser.add_argument(
        ...
        type=pathlib.Path,
        required=False,
        help="Directory to output files generated by this script. Same as "
             "--content-directory by default.",
    )
    parser.set_defaults(function="manubot.airevision.airevision_command.cli_process")
