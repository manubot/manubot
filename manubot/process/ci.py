...
def get_continuous_integration_parameters():
    ...
    if os.getenv('TRAVIS', 'false') == 'true':
        ...
        return {
            ...
            'triggering_commit': os.getenv('TRAVIS_PULL_REQUEST_SHA') or os.environ['TRAVIS_COMMIT'],
    ...
    if os.getenv('APPVEYOR', 'false').lower() == 'true':
        ...
        return {
            ...
            'triggering_commit': os.getenv('APPVEYOR_PULL_REQUEST_HEAD_COMMIT') or os.environ['APPVEYOR_REPO_COMMIT'],
